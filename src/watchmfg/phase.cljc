(ns watchmfg.phase
  "Phase 0->3 staged rollout for the watch/clock plant-operations
  coordination actor.
  ...
  consequence (a movement-assembly/casing/regulation/testing-equipment
  ...
  `watchmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Watch & Clock Plant Operations Governor verdict to a base
