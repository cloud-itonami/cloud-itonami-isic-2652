# Operator Quickstart — Manufacture of watches and clocks

Shortest path from clone to a verified local dry-run for **ISIC 2652** (`cloud-itonami-isic-2652`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2652.git
cd cloud-itonami-isic-2652
```
...
- Blueprint governor key: `watch-clock-plant-operations-governor`
- Likely source path: `watchmfg.governor.cljc`
