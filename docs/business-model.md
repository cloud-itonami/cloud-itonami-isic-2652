# Business Model: Manufacture of watches and clocks
...
## Classification
- Repository: `cloud-itonami-isic-2652` ([github.com/cloud-itonami/cloud-itonami-isic-2652](https://github.com/cloud-itonami/cloud-itonami-isic-2652))
- ISIC Rev.5: `2652` — Manufacture of watches and clocks
- Domain: `:watch-clock/manufacturing`
- Social impact: :worker-safety :materials-safety :precision-quality-integrity
- Actor: `:watch-clock-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :watch-clock/manufacturing — who wants
...
One managed tenant (:watch-clock/manufacturing):
...
- Do not bypass the `:watch-clock-plant-operations-governor` for production decisions.
