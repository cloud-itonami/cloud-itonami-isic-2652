(ns watchmfg.registry-test
  (:require [clojure.test :refer [deftest is]]
            [watchmfg.registry :as r]))
...
(deftest known-product-types-are-valid
  (doseq [pt [:mechanical-watch :automatic-watch :quartz-watch :chronograph-watch
...
;; ----------------------------- accuracy-test-seconds-per-day-valid? -----------------------------

(deftest typical-accuracy-test-reading-is-valid
  (is (r/accuracy-test-seconds-per-day-valid? -60.0))
  (is (r/accuracy-test-seconds-per-day-valid? -4.0))
  (is (r/accuracy-test-seconds-per-day-valid? 0.0))
  (is (r/accuracy-test-seconds-per-day-valid? 6.0))
  (is (r/accuracy-test-seconds-per-day-valid? 60.0)))

(deftest excessive-accuracy-test-reading-is-invalid
  (is (not (r/accuracy-test-seconds-per-day-valid? 999999.0)))
  (is (not (r/accuracy-test-seconds-per-day-valid? 60.01)))
  (is (not (r/accuracy-test-seconds-per-day-valid? -60.01))))

(deftest non-numeric-or-missing-accuracy-test-reading-is-invalid
  (is (not (r/accuracy-test-seconds-per-day-valid? nil)))
  (is (not (r/accuracy-test-seconds-per-day-valid? "5"))))
